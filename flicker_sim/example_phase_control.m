...
%===============================================================================
% References:
% [1] http://www.solcept.ch/en/FlickerSim
%===============================================================================
...
NUMOF_CYCLES       = 10; % number of switching cycles to simulate

CONST_LENGTH = SWITCHING_INTERVAL - RAMP_LENGTH;

FIGURE_TAG = 'example_phase_control';
...
%% Get or create browser figure handle
h_figure = findobj(0, 'Tag', FIGURE_TAG);
if (isempty(h_figure))
  h_figure = figure;
  set(h_figure, 'Tag', FIGURE_TAG);
end
figure(h_figure);
clf(h_figure);
