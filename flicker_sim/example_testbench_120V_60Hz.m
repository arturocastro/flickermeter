function example_testbench_120V_60Hz
% example_testbench_120V_60Hz - Flickermeter Simulator Performance Test
%
...
% [2] http://www.solcept.ch/en/FlickerSim
%===============================================================================
...
F_LINE               =   60;  % line frequency in Hz
...
rate = [    1,     2,     7,    39,   110,  1620,  4800];
% magnitude of relative voltage changes in percent
d    = [3.166, 2.568, 1.695, 1.044, 0.841, 0.547, 4.834];
